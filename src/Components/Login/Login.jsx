            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-3.5 border ${errors.email ? 'border-red-500' : 'border-purple-100'} rounded-2xl focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all`}
                />
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-3.5 border ${errors.password ? 'border-red-500' : 'border-purple-100'} rounded-2xl focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all`}
                />
              ...
              <button
                type="submit"
                className="w-full bg-purple-600 text-white py-4 rounded-2xl hover:bg-purple-700 transition-colors flex items-center justify-center gap-2 text-lg font-semibold shadow-lg shadow-purple-200 hover:shadow-purple-300"
              >
                Sign up
