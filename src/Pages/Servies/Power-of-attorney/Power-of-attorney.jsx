...
import { PowerAttorney } from "../../../utils/sevicecontent";
import {
  Gavel,
  DollarSign,
  Calendar,
...
const getContentId = (urlParam) => {
  const urlMappings = {
    // General Power of Attorney variations
    'general-power': 'GeneralPower',
    'general-power-of-attorney': 'GeneralPower',
    'power-of-attorney-general': 'GeneralPower',
  
    // Attorney for Property variations
    'attorney-property': 'AttorneyProperty',
    'power-of-attorney-property': 'AttorneyProperty',
    'property-attorney': 'AttorneyProperty',
  
    // Attorney for NRI variations
    'attorney-nri': 'AttorneyNRI',
    'power-of-attorney-nri': 'AttorneyNRI',
    'nri-attorney': 'AttorneyNRI',
  
    // Revocation of Power variations
    'revocation-power': 'RevocationPower',
    'revocation-of-power-of-attorney': 'RevocationPower',
    'power-revocation': 'RevocationPower',
  
    // Special Power of Attorney variations
    'special-power': 'SpecialPower',
    'special-power-of-attorney': 'SpecialPower',
    'power-of-attorney-special': 'SpecialPower',
  
    // Development of Property variations
    'development-property': 'DevelopmentProperty',
    'power-of-attorney-development': 'DevelopmentProperty',
    'property-development-attorney': 'DevelopmentProperty',
  };

  // Clean the URL parameter
  const cleanUrl = urlParam?.toLowerCase().trim() || 'general-power';
  ...
  return partialMatch ? partialMatch[1] : 'GeneralPower';
};
...
const Powerofattorney = () => {
  ...
  useEffect(() => {
    ...
    const pageContent = PowerAttorney[contentId];
