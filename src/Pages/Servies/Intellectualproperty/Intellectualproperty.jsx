...
const getContentId = (urlParam) => {
  const urlMappings = {
    // Technical Know-How Agreement variations
    'technical-know-how': 'Technical-Know-How ',
    'know-how-agreement': 'Technical-Know-How ',
    'technical-know-how-agreement': 'Technical-Know-How ',
  
    // Assignment of Copyright variations
    'assignment-of-copyright': 'Assignment-of-Copyright',
    'copyright-assignment': 'Assignment-of-Copyright',
    'deed-of-assignment': 'Assignment-of-Copyright',
  
    // Agreement for Patent variations
    'agreement-patent': 'Agreement-Patent',
    'patent-agreement': 'Agreement-Patent',
    'patent-rights-agreement': 'Agreement-Patent',
  
    // Mortgage Agreement variations
    'mortgage': 'Mortgage',
    'mortgage-agreement': 'Mortgage',
    'agreement-mortgage': 'Mortgage',
  
    // Assignment of Patents variations
    'assignment-patents': 'AssignmentPatents',
    'patent-assignment': 'AssignmentPatents',
    'deed-of-assignment-patents': 'AssignmentPatents',
  
    // Author and Publisher Agreement variations
    'author-and-publisher': 'Author-and-Publisher',
    'author-publisher-agreement': 'Author-and-Publisher',
    'agreement-author-publisher': 'Author-and-Publisher',
  
    // New Publisher Agreement variations
    'new-publisher': 'New-Publisher',
    'new-publisher-agreement': 'New-Publisher',
  
    // Trade Mark Agreement variations
    'trade-mark': 'Trade-Mark',
    'trademark-agreement': 'Trade-Mark',
    'agreement-trademark': 'Trade-Mark',
  
    // Manufacturer Agreement variations
    'manufacturer-agreement': 'Manufacturer-Agreeme',
    'agreement-manufacturer': 'Manufacturer-Agreeme',
    'trademark-manufacturer-agreement': 'Manufacturer-Agreeme',
  };

  // Clean the URL parameter
  const cleanUrl = urlParam?.toLowerCase().trim() || 'technical-know-how';
  ...
  return partialMatch ? partialMatch[1] : 'Technical-Know-How';
};
...
const Intellectual = () => {
  ...
  useEffect(() => {
    ...
    const pageContent = intellectual[contentId];
