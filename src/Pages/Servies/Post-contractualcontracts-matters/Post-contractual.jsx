...
import { postContractual } from "../../../utils/sevicecontent";
import {
  Gavel, DollarSign, Calendar, Wrench, Scale, FileCheck,
  ChevronRight, ChevronLeft, Shield, Clock, FileText,
} from "lucide-react";
...
const iconMap = {
  DollarSign, Calendar, Wrench, Scale, FileCheck,
  Gavel, Shield, Clock, FileText,
};

const getContentId = (urlParam) => {
  const urlMappings = {
    "variation-amendment": "VariationAmendment",
    "amendment-agreement": "VariationAmendment",
    "variation-agreement": "VariationAmendment",
    "termination-agreement": "TerminationAgreement",
    "termination": "TerminationAgreement",
    "notice-termination": "TerminationAgreement",
    "side-letters": "SideLetters",
    "side-letter-agreement": "SideLetters",
    "side-agreement": "SideLetters",
    "interim-agreement": "InterimAgreement",
    "interim": "InterimAgreement",
    "temporary-agreement": "InterimAgreement",
    "change-order": "ChangeOrder",
    "change-order-agreement": "ChangeOrder",
    "order-change-agreement": "ChangeOrder",
    "releases-contract": "ReleasesContract",
    "contract-cancellation": "ReleasesContract",
    "cancellation-agreement": "ReleasesContract",
    "post-incorporation": "Postincorporation",
    "post-incorporation-agreement": "Postincorporation",
    "incorporation-agreement": "Postincorporation",
  };

  const cleanUrl = urlParam?.toLowerCase().trim() || "variation-amendment";
  return urlMappings[cleanUrl] || "VariationAmendment";
};
const validateContent = (content) => {
  if (!content) return false;
};
const PostContractual = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    ...
    const pageContent = postContractual?.[contentId]
...
export default PostContractual;
