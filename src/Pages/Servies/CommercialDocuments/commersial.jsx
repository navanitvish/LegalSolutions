...
import { commercial } from "../../../utils/sevicecontent";
import {
  Gavel,
  DollarSign,
  Calendar,
...
const getContentId = (urlParam) => {
  const urlMappings = {
    // Supply Agreement variations
    'supply-agreement': 'Supplyagreement',
    'supplyagreement': 'Supplyagreement',
    'supply-agreement-contract': 'Supplyagreement',
    'supply-agreement-doc': 'Supplyagreement',
  
    // Distribution Agreement variations
    'distribution-agreement': 'Distributionagreemen',
    'distributionagreement': 'Distributionagreemen',
    'distribution-agreement-contract': 'Distributionagreemen',
    'distribution-agreement-doc': 'Distributionagreemen',
  
    // Franchise Agreement variations
    'franchise-agreement': 'Franchiseagreement',
    'franchiseagreement': 'Franchiseagreement',
    'franchise-agreement-contract': 'Franchiseagreement',
    'franchise-agreement-doc': 'Franchiseagreement',
  
    // Service Agreement variations
    'service-agreement': 'Serviceagreement',
    'serviceagreement': 'Serviceagreement',
    'service-agreement-contract': 'Serviceagreement',
    'service-agreement-doc': 'Serviceagreement',
  
    // General Agreement variations
    'agreement': 'Serviceagreement', // Fallback to service agreement
    'contract': 'Serviceagreement',   // Fallback to service agreement
    'legal-agreement': 'Serviceagreement', // Fallback to service agreement
  };
  ...
  return partialMatch ? partialMatch[1] : 'Supplyagreement';
};
...
const Commercialdoc = () => {
  ...
  useEffect(() => {
    ...
    const pageContent = commercial[contentId];
