...
import { wills } from "../../../utils/sevicecontent";
import {
  Gavel,
  DollarSign,
  Calendar,
...
const getContentId = (urlParam) => {
  const urlMappings = {
    // General Will variations
    'general': 'generalwill',
    'general-will': 'generalwill',
    'generalwill': 'generalwill',
    'standard-will': 'generalwill',
    'basic-will': 'generalwill',
    
    // Islamic Will variations
    'islamic': 'Islamicwill',
    'islamic-will': 'Islamicwill',
    'islamicwill': 'Islamicwill',
    'muslim-will': 'Islamicwill',
    'sharia-will': 'Islamicwill'
  };

  // Clean the URL parameter and provide default if none provided
  const cleanUrl = urlParam?.toLowerCase().trim() || 'general';
  ...
  // Return the matched content ID or default to generalwill
  return partialMatch ? partialMatch[1] : 'generalwill';
};
...
const Willspage = () => {
  ...
  useEffect(() => {
    ...
    const pageContent = wills[contentId];
