...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full bg-white min-h-screen flex flex-col items-center justify-center px-4 py-8 sm:py-16 lg:py-20 overflow-hidden">
      {/* Background beams */}
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto text-center mb-12 sm:mb-16 lg:mb-20">
        <h1 className="text-4xl sm:text-5xl lg:text-[70px] font-bold mb-4 sm:mb-6 text-gray-900 leading-tight">
          Make proposals<br className="hidden sm:inline" /> that make impressions
        </h1>
