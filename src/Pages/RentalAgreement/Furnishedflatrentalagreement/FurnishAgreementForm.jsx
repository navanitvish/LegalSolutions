...
import {FurnishedhousegenerateAgreementText} from '../../../utils/DocumentData';
import PaymentService from '../../../services/Payment';
import ApiService from '../../../api/api';


// Mock services (replace with actual imports in your project)
...
export default function FurnishedhouseAgreementForm() {
  ...
  const validateStep = (currentStep) => {
    const requiredFields = {
      1: ['state', 'ownerName', 'ownerRelation', 'ownerRelatedName', 'ownerAge', 'ownerAddress', 'ownerPan', 'ownerAadhaar', 'ownerContact'],
      2: ['tenantName', 'tenantRelation', 'tenantRelatedName', 'tenantAge', 'tenantAddress', 'tenantPan', 'tenantAadhaar', 'tenantContact'],
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const paymentData = {
        ...
        description: 'Furnished House Rental Agreement Draft',
      ...
      if (paymentResponse.success) {
        ...
        // Generate agreement after successful payment
        const agreementResponse = await ApiService.generateAgreement({
          ...formData,
          orderId: paymentResponse.orderId,
          agreementText: FurnishedhousegenerateAgreementText(formData)
        });
  ...
  const agreementText = FurnishedhousegenerateAgreementText(formData);
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-6">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
            Furnished House Rental Agreement Generator
          </h1>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <div className="text-center mb-6 pb-4 ">
                    <h1 className="text-xl md:text-xl font-bold text-gray-900 uppercase tracking-wide">
                      FURNISHED FLAT RENTAL AGREEMENT
                    </h1>
                  </div>
