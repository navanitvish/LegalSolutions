...
const flatRentalPage = () => {
  ...
  const features = [
    {
      ...
      description: "Clearly outlines rental terms, payment schedules, and security deposit. ",
    },
    {
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        "Outlines access to common areas such as kitchens, bathrooms, and living spaces.",
    },
    {
      icon: Scale,
    ...
    },
    {
      ...
      description:
        "Legally compliant with Indian rental laws.",
    },
  ];
  ...
  const whyNeedAgreement = [
    {
      ...
      desc: "Safeguards the rights of both landlords and tenants, minimizing disputes.",
    },
    {
      title: "Transparency",
      desc: "Clearly outlines rental terms, house rules, and responsibilities.",
    },
    {
      title: "Dispute Resolution",
      desc: "Provides a legal framework for addressing conflicts or breaches.",
    },
    {
      title: "Compliance",
    ...
    {
      title: "Flexibility",
      desc: "Customizable to suit individual requirements and living arrangements.",
    },
    {
      title: "Shared Accommodation",
      desc: "Specifies the use of shared spaces and utility contributions. ",
    },
  ];
  ...
  const RoomRental  = [
    ...
    },
    {
      ...
      desc: "Select Room Rental Agreement from our list of options.",
    },
    {
    ...
    {
      title: "Define Terms",
      desc: "Specify any additional terms you wish to include regarding shared facilities or responsibilities.",
    },
    {
    ...
    },
    {
      ...
      desc: "Include legally valid e-stamp paper if required.",
    },
    {
      title: "E-Signature",
      desc: "Utilize Aadhaar-based e-signatures for secure signing.",
    },
    {
  ...
  const whyChooseUsflat = [
    {
      ...
      desc: "Get your Room Rental Agreement ready in minutes without unnecessary delays.",
    },
    {
      title: "Customizable Document",
      desc: "Tailor agreements specifically to your requirements regarding room rentals.",
    },
    {
      title: "Legally Compliant Solutions",
      desc: "Ensure all agreements adhere to Indian rental laws applicable to room rentals.",
    },
    {
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 z-10">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                A Room Rental Agreement is a legally binding document between a
                landlord and a tenant that defines the terms and conditions of
                renting a room in a property. It is particularly useful for
                shared accommodations or standalone room rentals, ensuring
                transparency and protects the interests of both parties by
                defining their rights and responsibilities regarding the rented
                space.
              </p>
            </div>
