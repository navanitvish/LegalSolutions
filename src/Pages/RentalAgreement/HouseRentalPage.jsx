...
// import RentalPage from "../Servies/LeaseAgreements/Residential-lease-agreement";
...
const flatRentalPage = () => {
  ...
  const features = [
    {
      ...
      description: "Specifies rental amount, payment terms, and security deposit.",
    },
    {
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        "Outlines maintenance, utility, and repair responsibilities.",
    },
    {
      icon: Scale,
      title: "Legal Framework",
      description:
        "Includes clauses for termination, renewal, and dispute resolution.",
    },
    {
      icon: FileCheck,
      title: "Rights Protection",
      description:
        "Provides enforceable terms that safeguard both parties' rights.",
    },
  ];
  ...
  const whyNeedAgreement = [
    {
      ...
      desc: "Clearly defines the terms of the rental arrangement, avoiding misunderstandings.",
    },
    {
      title: "Legal Protection",
      desc: "Safeguards the rights of both landlords and tenants against potential disputes.",
    },
    {
      title: "Dispute Resolution",
      desc: "Provides a clear framework for addressing disputes or breaches of agreement.",
    },
    {
    ...
    {
      title: "Compliance",
      desc: "Ensures adherence to applicable state-specific rental laws in India.",
    },
    {
      title: "Flexibility",
      desc: "Allows for customization to meet individual needs and circumstances.",
    },
    {
      title: "Security of Tenure",
      desc: "Protects tenants from unlawful eviction while ensuring landlords are compensated for their property, non-payment or property misuse.",
    },
  ];
  ...
  const legalFramework = [
    ...
    },
    {
      ...
      desc: "Such as the Maharashtra Rent Control Act, 1999, which applies to properties in Maharashtra.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "While not legally mandatory, having a rental agreement is highly recommended to avoid disputes and protect the rights of both parties.",
    },
    {
  ...
  const rentalSteps = [
    ...
    },
    {
      ...
      desc: "Select House Rental Agreement suited for your property from our comprehensive list of Rental Agreements.",
    },
    {
...
"
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 z-10">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                A House Rental Agreement is a legally binding document between a
                landlord (property owner) and a tenant (occupant) that outlines
                the terms and conditions of renting a residential property. This
                agreement ensures clarity and protects the interests of both
                parties by defining their rights and responsibilities.
              </p>
            </div>
      ...
      {/* steps */}
      <ChainSteps
        title="How to Create a House Rental Agreement with MyLegalInstant.com"
        steps={rentalSteps}
      />
