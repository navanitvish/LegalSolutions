 ...
 const faqs = [
  ...
  const rentalSteps = [
    ...
    },
    {
      ...
      desc: "Choose Furnished House Rent Agreement from our comprehensive rental agreements segment.",
    },
    {
    ...
    <div className=" w-full">
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 z-10">
              <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 mb-8">
                What is a Furnished House Rent Agreement?
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed">
                A Furnished House Rent Agreement is a legal document that
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 overflow-hidden">
        <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">
          Why Do You Need a Furnished House Rent Agreement?
        </h2>
      ...
      {/* steps */}
      <ChainSteps
        title="How to Create a Furnished House Rent Agreement"
        steps={rentalSteps}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="bg-gradient-to-br from-indigo-200 to-purple-600 rounded-2xl p-8 md:p-12 text-center shadow-xl">
          ...
          <p className="text-purple-100 mb-8 text-lg max-w-3xl mx-auto">
            Secure your Furnished House Rent Agreement with a professionally drafted
