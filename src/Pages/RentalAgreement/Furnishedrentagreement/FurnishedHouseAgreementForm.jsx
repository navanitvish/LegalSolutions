...
import {FurnishedFlatgenerateAgreementText} from '../../../utils/DocumentData';
...
export default function FurnishedhouseAgreementForm() {
    ...
    try {
      ...
      if (paymentResponse.success) {
        ...
        const agreementResponse = await ApiService.generateAgreement({
          ...
          agreementText: FurnishedFlatgenerateAgreementText(formData)
        });
  ...
  const agreementText = FurnishedFlatgenerateAgreementText(formData);
