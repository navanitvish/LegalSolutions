...
import { ChevronRightIcon, ChevronDownIcon, Sparkles, ArrowRight } from "lucide-react";

const Products = () => {
  const [activeAccordion, setActiveAccordion] = useState(null);
  const navigate = useNavigate();

  // Centralized products data with navigation configuration
  const products = [
    {
      id: "e-stamp-corner",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 max-w-3xl mx-auto">
              {[
                ...
                <div key={index} className="p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-purple-100">
            ...
            >
              ...
              <div className="p-6 text-left">
                ...
                <div className="mt-4 flex items-center justify-between">
                  <button className="flex items-center text-purple-600 font-medium text-sm">
                    Learn More
